...
> 当前 Roblox 项目不能一开始就做完整《横扫千军》，应该先做 MVP 闭环：选主公 → 主城 → 资源采集 → 商店/背包 → 副本 → 奖励回流 → 角色成长。

如果你能这样讲，你就不是单纯执行代码的人，而是在往“项目负责人 / 全栈开发”方向走。


我不会这样讲，但是我会先选定好框架，然后做MVP版本，自己默默的执行

额外话题说一些，我最终的目标是呆在家里做独立游戏开发。目前是老板安排我到他朋友的公司去做Roblox游戏项目，他们公司之前做成功了一个项目，所以也是希望我快速成长学习，项目做完学完后回来再做项目，因为目前的这个项目 就是低成本试水我也看出来了，其次就是效率太低，周围都是第一次做，一直各种踩坑。我也希望能跟着老板一直干，现在公司就是美术外包，养我一个开发，我感觉我什么都要会